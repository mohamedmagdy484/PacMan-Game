...
// ──────────────────────────────────────────────────────────────────
// Collision handling (replaces collision.cpp)
// ──────────────────────────────────────────────────────────────────
...
int main(int /*argc*/, char* /*argv*/[]) {
    ...
    while (keepPlaying) {
        ...
        while (running && lives > 0) {
            ...
            // ── Level complete ───────────────────────────────────
            if (!dotsRemain()) {
                // Flash maze walls briefly (arcade tradition)
                for (int f = 0; f < 6; f++) {
                    // We reuse the normal frame but invert wall colours by
                    // briefly drawing a white overlay over the maze area
